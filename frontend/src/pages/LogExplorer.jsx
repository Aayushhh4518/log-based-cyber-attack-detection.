    ...
    <div className="space-y-6 h-full flex flex-col">
      ...
      <div className="bg-slate-800 rounded-lg border border-slate-700 overflow-hidden flex-1 flex flex-col">
        <div className="p-4 border-b border-slate-700 bg-slate-800/50 flex justify-between items-center">
          <h3 className="font-semibold text-slate-100">Raw Log Events <span className="text-xs text-amber-500 ml-2 border border-amber-500/30 bg-amber-500/10 px-2 py-0.5 rounded">DEMONSTRATION DATA</span></h3>
            ...
            <tbody className="divide-y divide-slate-700/50 text-sm">
              {filteredLogs.map((log) => (
                ...
                >
                  ...
                  <td className="px-6 py-3 whitespace-nowrap font-sans">{log.eventType}</td>
                  ...
                  <td className="px-6 py-3 whitespace-nowrap">{log.username}</td>
                  <td className="px-6 py-3 whitespace-nowrap">{log.sourceIp}</td>
